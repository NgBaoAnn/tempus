...
private object TreeColors {
    ...
    val coconutBrown = Color(0xFF6D4C41)  
    val coconutGreen = Color(0xFF8BC34A)  
            ...
            parts = TreeParts(
                ...
                leafClusters = listOf(
                    LeafClusterConfig(
                        ...
                        1.0f,  
                        if (state == TreeState.TREE) 0.25f else 0.18f,  
                        7,  
        ...
        TreeState.TREE -> TreeRenderConfig(
            parts = TreeParts(
                ...
                branches = listOf(
                    ...
                    BranchConfig(0.50f, 0.30f, 0.055f, -50f, stablePhaseOffset(seed, 0), TreeColors.brownMedium),  
                    BranchConfig(0.55f, 0.28f, 0.05f, 45f, stablePhaseOffset(seed, 1), TreeColors.brownMedium),   
                    BranchConfig(0.65f, 0.32f, 0.05f, -20f, stablePhaseOffset(seed, 2), TreeColors.brownMedium),  
                    BranchConfig(0.70f, 0.30f, 0.045f, 25f, stablePhaseOffset(seed, 3), TreeColors.brownMedium),  
                    BranchConfig(0.80f, 0.25f, 0.04f, -5f, stablePhaseOffset(seed, 4), TreeColors.brownLight),    
                    BranchConfig(0.82f, 0.22f, 0.035f, 15f, stablePhaseOffset(seed, 5), TreeColors.brownLight),   
                    
                    BranchConfig(0.45f, 0.18f, 0.025f, -70f, stablePhaseOffset(seed, 6), TreeColors.brownLight),  
                    BranchConfig(0.48f, 0.15f, 0.02f, -90f, stablePhaseOffset(seed, 7), TreeColors.brownLight),   
                    BranchConfig(0.52f, 0.18f, 0.025f, 60f, stablePhaseOffset(seed, 8), TreeColors.brownLight),   
                    BranchConfig(0.55f, 0.15f, 0.02f, 80f, stablePhaseOffset(seed, 9), TreeColors.brownLight)     
                ),
        ...
        baseConfig.copy(
            parts = baseConfig.parts.copy(
                fruits = listOf(
                    ...
                    FruitConfig(LeafAttachment.TRUNK, 0.35f, 0.05f, TreeColors.appleRed, 0f),      
                    FruitConfig(LeafAttachment.TRUNK, 0.55f, 0.048f, TreeColors.appleRed, 2.0f),   
                    FruitConfig(LeafAttachment.TRUNK, 0.40f, 0.045f, TreeColors.appleGreen, 4.0f), 
                    FruitConfig(LeafAttachment.TRUNK, 0.60f, 0.046f, TreeColors.appleRed, 1.0f),   
                    FruitConfig(LeafAttachment.TRUNK, 0.50f, 0.044f, TreeColors.appleRed, 3.0f),   
                    FruitConfig(LeafAttachment.TRUNK, 0.45f, 0.042f, TreeColors.appleGreen, 5.0f)  
                ),
                baseColor = TreeColors.greenMedium
            )
        )
    ...
    return when (state) {
        ...
        TreeState.TREE -> TreeRenderConfig(
            parts = TreeParts(
                ...
                leafClusters = listOf(
                    LeafClusterConfig(LeafAttachment.TRUNK, 1f, 0.30f, 0, TreeColors.greenLight, -70f, LeafShape.FROND),  
                    LeafClusterConfig(LeafAttachment.TRUNK, 1f, 0.28f, 1, TreeColors.greenLight, -35f, LeafShape.FROND),  
                    LeafClusterConfig(LeafAttachment.TRUNK, 1f, 0.26f, 2, TreeColors.greenMedium, 0f, LeafShape.FROND),   
                    LeafClusterConfig(LeafAttachment.TRUNK, 1f, 0.28f, 3, TreeColors.greenLight, 35f, LeafShape.FROND),   
                    LeafClusterConfig(LeafAttachment.TRUNK, 1f, 0.30f, 4, TreeColors.greenLight, 70f, LeafShape.FROND)    
                ),
                fruits = listOf(
